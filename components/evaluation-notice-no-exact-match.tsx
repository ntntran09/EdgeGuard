...
export function EvaluationNoticeNoExactMatch() {
  return (
    <div className="rounded-2xl border border-teal-200 bg-teal-50 px-5 py-4 text-sm leading-6 text-teal-950">
      ...
      <details className="mt-3 rounded-xl border border-teal-200 bg-white/55 px-4 py-3">
        ...
        <div className="mt-3 space-y-2 text-teal-950">
          <p>Edge Impulse cung cấp ground truth bbox, prediction bbox, class và confidence score. Web tự chấm lại TP, FP, FN, TN theo logic bên dưới, không lấy trực tiếp từ Edge Impulse.</p>
          ...
          <p><strong>Độ chính xác FOMO:</strong> Nhóm quy ước Micro F1 là chỉ số chính để báo cáo độ chính xác của mô hình FOMO vì chỉ số này gộp TP, FP, FN trên toàn bộ class và cân bằng giữa Precision với Recall.</p>
        </div>
      </details>
    </div>
  );
