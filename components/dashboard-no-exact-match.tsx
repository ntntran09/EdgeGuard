...
import { EvaluationNoticeNoExactMatch } from "./evaluation-notice-no-exact-match";
import { ExportMenuNoExactMatch } from "./export-menu-no-exact-match";
import { SampleResultsTable } from "./sample-results-table";
import { SummaryMetricsNoExactMatch } from "./summary-metrics-no-exact-match";
...
export function DashboardNoExactMatch() {
      ...
      <div className="space-y-5">
        ...
        {!data || !context || !evaluation ? (
          ...
          <>
            ...
            <SummaryMetricsNoExactMatch metrics={evaluation.overallMetrics} />
            ...
            <SampleResultsTable
              ...
              confidenceThreshold={confidenceThreshold}
            />
            {report && <ExportMenuNoExactMatch report={report} />}
          </>
        )}
      </div>
